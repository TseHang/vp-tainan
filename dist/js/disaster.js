  ...
  L.geoJSON(liquefactionArea, {
    style: function style(feature) {
      switch (feature.properties['分級']) {
        case '低潛勢':
          lStyle.fillOpacity = 0.2;break;
        case '中潛勢':
          lStyle.fillOpacity = 0.4;break;
        case '高潛勢':
          lStyle.fillOpacity = 0.6;break;
        default:
          console.log("undefined error");break;
      }
      return lStyle;
    }
  }).addTo(map);
...
$.getJSON('./src/data/disaster-water.json', function (json) {
  waterArea = json;
