            ...
            success: function(data) {
              ...
              for(var i in suppleArea) {
                ...
                var marker = L.marker(L.latLng(
                  ...
                  {icon: readMarker, town: suppleArea[i]['轄區'].split("、")})
                  .addTo(siteMap);
                marker.bindPopup('<strong>' + suppleArea[i]['淨水場名稱'] 
                                + '</strong><br>主要供水轄區:<strong>' + suppleArea[i][' 主要供水轄區']
                                +'</strong><br>總溶解固體量(Total Dissolved Solids):<strong>'+ suppleArea[i]['總溶解固體量(Total Dissolved Solids)']
                                +'</strong><br>pH值(pH ):<strong>' + suppleArea[i]['pH值(pH )']
                                +'</strong><br>總硬度(Total Hardness):<strong>' + suppleArea[i]['總硬度(Total Hardness)']
                                +'</strong><br>鐵(Iron):<strong>' + suppleArea[i]['鐵(Iron)']
                                +'</strong><br>水質合格否(Y/N):<strong>' + suppleArea[i]['水質合格否(Y/N)'] + '</strong>');
